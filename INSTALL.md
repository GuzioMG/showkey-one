...
They made very small modifications to this file, and said modifications are now redistributed, as allowed by the notice above („distribution of this file, with [...] modification, are permitted in any medium”). In order to comply with said notice, its text *and also all legal implications of it* are in the modified version, ie. you're allowed to redistribute/modify it and there is no warranty.